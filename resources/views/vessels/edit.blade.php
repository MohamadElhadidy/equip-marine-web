@extends('layout.app')
@section('title', ' تعديل تصريح خروج مُعِــــده')
@section('style')
...
@section('body')
      ...
      <section class="section">
          <div class="section-header">
            <h1> تعديل تصريح خروج مُعِــــده (تشغيل السفن)</h1>
                ...
                <div class="card">
                  <form method="post" class="needs-validation" novalidate="" action="/vessels" enctype="multipart/form-data"  id="myForm" dir="rtl">
                    ...
                    <div class="card-body">
                      ...
                      <strong  class="float-right" style="color: red;">{{ $errors->first('equipment') }}</strong>
                        ...
                        @foreach ( $vessels as $vessel0)
                            <option value="{{ $vessel0->name }}" {{ ($vessel->vessel == $equipment->id ? "selected":"") }}> {{ $vessel0->name }}</option>
                        @endforeach                   
                      </select>       
                      ...
                      <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="plan"   value="{{ $vessel->plan }}"  required="">
                      ...
                      <div class="row">         
                        ...
                        @foreach ( $companies as $company)
                            <option value="{{ $company->id }}" {{ ($vessel->company == $company->id ? "selected":"") }}> {{ $company->name_ar }}</option>
                        @endforeach                   
                      </select>       
                      ...
                      <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="duration"   value="{{ $vessel->duration }}"  required="">
                        ...
                        <strong  class="float-right" style="color: red;">{{ $errors->first('duration') }}</strong>
                          ...
                          <div class="form-group col-md-4 col-12">
                            ...
                            <textarea  class="form-control"  name="details" cols="50"  required>{{ $vessel->details }}</textarea>
                    ...
                    <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="driver"   value="{{ $vessel->driver }}"  required="">
                      ...
                      <strong  class="float-right" style="color: red;">{{ $errors->first('driver') }}</strong>
                          ...
                          <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="notes"   value="{{ $vessel->notes }}" >
                          </div>
                        </div>
