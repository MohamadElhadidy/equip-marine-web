@extends('layout.app')
@section('title', 'طلب خروج مُعِــــده')
@section('style')
          ...
          <div class="section-body">
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form method="post" class="needs-validation" novalidate="" action="/requests" enctype="multipart/form-data"  id="myForm" dir="rtl">
                    @csrf
