@extends('layout.app')
@section('title', 'تقرير الورش الداخلية')
@section('style')
...
@section('body')
 ...
 <section class="section">
        ...
        <table id='table'   dir="rtl" width="100%">
            <thead>
                <tr>
                    <th>كود الورشة الداخلية</th>
                    <th>اسم الورشة الداخلية</th>
                    <th>الشركة التابعة لها</th>
                    <th>الموقع</th>
                    <th>الإدارة التابعة لها</th>
                    <th>تفاصيل أخرى</th>
        ...
        var dt = $('#table').DataTable({
            ...
            buttons: [

                {
                    ...
                    messageTop: '<img src="/images/workshops.png" style="position:relative;width:100%;" />',
                    autoPrint: true,
                    title:'',
                    exportOptions: {
                        columns: [0, 1, 2, 3,4]
