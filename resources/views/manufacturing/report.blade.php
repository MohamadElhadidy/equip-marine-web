@extends('layout.app')
@section('title', ' تقرير معدات تحت التصنيع')
@section('style')
        ...
        var dt = $('#table').DataTable({
            ...
            buttons: [

                {
                    ...
                    messageTop: '<img src="/images/manu.png" style="position:relative;width:100%;" />',
                    autoPrint: true,
                    title:'',
                    exportOptions: {
                        columns: [0, 1, 2,3]
