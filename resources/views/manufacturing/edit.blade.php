@extends('layout.app')
@section('title', 'تعديل تصنيع مُعِــــده ')
@section('style')
...
@section('body')
      ...
      <section class="section">
          <div class="section-header">
            <h1>تعديل تصنيع  مُعِــــده </h1>
            
          </div>
          <div class="section-body">
            @if (session('EditManufacturing'))
                <div class="alert alert-success">
                    {{ session('EditManufacturing') }}
                </div>
            @endif
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form method="post" class="needs-validation" novalidate="" action="/manufacturing/{{ $manufacturing->id }}"  enctype="multipart/form-data"  id="myForm" dir="rtl">
                    @csrf
                    ...
                    <div class="card-body">
                      <div class="row">         
                          ...
                          <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="code"   value="{{$manufacturing->code }}"  required="">
                       ...
                       <strong  class="float-right" style="color: red;">{{ $errors->first('code') }}</strong>
                         ...
                         <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="name"   value="{{ $manufacturing->name }}"  required="">
                       ...
                       <strong  class="float-right" style="color: red;">{{ $errors->first('name') }}</strong>
                          ...
                          <input type="text"   value="{{ $manufacturing->start_date}}" name="start_date"  class="form-control datepicker">
                        ...
                        <div class="row">         
                          ...
                          <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="notes"   value="{{ $manufacturing->notes}}"  >
                          </div>
                        </div>
