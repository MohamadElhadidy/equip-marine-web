@extends('layout.app')
@section('title', 'تعديل طلب إصلاح مُعِــــده ')
@section('style')
...
@section('body')
      ...
      <section class="section">
          <div class="section-header">
            <h1>تعديل طلب إصلاح مُعِــــده </h1>
            
          </div>
          <div class="section-body">
            @if (session('EditMaintenance'))
                <div class="alert alert-success">
                    {{ session('EditMaintenance') }}
                </div>
            @endif
            ...
            <div class="row mt-sm-4">
              <div class="col-12 col-md-12 col-lg-12">
                <div class="card">
                  <form method="post" class="needs-validation" novalidate="" action="/maintenance/{{ $maintenance->id }}"  enctype="multipart/form-data"  id="myForm" dir="rtl">
                    @csrf
                    ...
                    <div class="card-body">
                      <div class="row">         
                        ...
                        @foreach ( $equipments as $equipment)
                            <option value=" {{ $equipment->id }}" {{ ($maintenance->equipment == $equipment->id ? "selected":"") }}> {{ $equipment->name }}</option>
                        @endforeach                   
                      </select>       
 ...
 <div class="form-group col-md-4 col-12">
                            ...
                            <textarea  class="form-control"  name="details" cols="50"  required>{{ $maintenance->details }}</textarea>
                           ...
                           <div class="form-group col-md-4 col-12">
                            ...
                            <input type="text" class="form-control"  name="notes"   value="{{ $maintenance->notes}}"  >
                          </div>
                        </div>
